...
!###############################################################################
   ...
   subroutine write_moments_to_netcdf_file(nout, timer)
      ...
      complex, dimension(:, :, :, :, :), allocatable :: dens_vs_kykxzts, upar_vs_kykxzts, temp_vs_kykxzts, pres_perp_vs_kykxzts, spitzer2_vs_kykxzts 
      ...
      allocate (pres_perp_vs_kykxzts(naky, nakx, nztot, ntubes, nspec))
      ...
      ! Calculate the moments for a flux tube simulation
         ...
         call get_moments_fluxtube(gnew, dens_vs_kykxzts, upar_vs_kykxzts, temp_vs_kykxzts, pres_perp_vs_kykxzts, spitzer2_vs_kykxzts)
      end if

      ! Write the moments to the netcdf file
      if (proc0 .and. write_moments) call write_moments_nc(nout, dens_vs_kykxzts, upar_vs_kykxzts, temp_vs_kykxzts, &
        pres_perp_vs_kykxzts, spitzer2_vs_kykxzts)
      ...
      deallocate (dens_vs_kykxzts, upar_vs_kykxzts, temp_vs_kykxzts, pres_perp_vs_kykxzts, spitzer2_vs_kykxzts)
   ...
   !============================================================================
   subroutine get_moments_fluxtube(g, density, upar_vs_kykxzts, temperature, pres_perp, spitzer2_vs_kykxzts)
      ...
      complex, dimension(:, :, -nzgrid:, :, :), intent(out) :: density, temperature, pres_perp, upar_vs_kykxzts, spitzer2_vs_kykxzts
      ...
      call integrate_vmu(integrand, spec%dens_psi0*spec%temp_psi0, pres_perp)
