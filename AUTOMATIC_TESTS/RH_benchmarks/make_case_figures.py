...
CASES = {
    ...
    2: ('linear_collisionless_multi',
        r'Case 2: linear, collisionless, two kinetic species, electromagnetic', {}),
    3: ('linear_collisional', 'Case 3: linear, collisional', {}),
    4: ('linear_collisional_multi',
        r'Case 4: linear, collisional, two kinetic species, electromagnetic', {}),
    5: ('nl_modified_adiabatic',
        'Case 5: nonlinear, modified-adiabatic electrons', dict(window=0.4)),
    6: ('nl_adiabatic',
        'Case 6: nonlinear, adiabatic electrons', dict(window=0.4)),
    7: ('nl_kinetic',
        'Case 7: nonlinear, kinetic ions and electrons', dict(window=0.4)),
    8: ('nl_em_apar',
        r'Case 8: nonlinear electromagnetic, $\delta A_\parallel$ only',
        dict(window=0.4)),
    9: ('nl_em_apar_bpar',
        r'Case 9: nonlinear electromagnetic, $\delta A_\parallel$ and $\delta B_\parallel$',
        dict(window=0.4)),
}
